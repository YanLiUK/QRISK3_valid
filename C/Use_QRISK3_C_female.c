...
//This C program used C version of QRISK3 to verify my R package
#include<stdio.h>
#include<math.h>
...
{  //Initialise results
   ...
   //Female example
   //The below corresponding to the first female patient in QRISK3_2019_test.csv
   ...
   int age=64, b_AF=0, b_atypicalantipsy=0, b_corticosteroids=0, b_migraine=0, b_ra=0,
   ...
   double town=0.0;
    ...
    exfe = cvd_female_raw(age, b_AF, b_atypicalantipsy, b_corticosteroids, b_migraine, b_ra,
                    b_renal, b_semi, b_sle, b_treatedhyp, b_type1, b_type2, bmi,
                    ethrisk, fh_cvd, rati, sbp, sbps5, smoke_cat, surv, town);
    printf("female risk is %lf \n", exfe);
system("pause");
return 0;
}